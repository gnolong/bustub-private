...
class LockManager {
 public:
  ...
  static constexpr bool COMPATIBLE_MATRIX[5][5] = {{true, true, true, true, false},
                                                   {true, true, false, false, false},
                                                   {true, false, true, false, false},
                                                   {true, false, false, false, false},
                                                   {false, false, false, false, false}};

  static constexpr bool UPGRADE_MATRIX[5][5] = {{false, true, true, true, true},
 ...
 private:
  ...
  std::unordered_map<txn_id_t, Transaction *> txn_mgr_;

  void DfsTxn(std::unordered_map<txn_id_t, int> &mp, txn_id_t id_p, txn_id_t *id_t, txn_id_t id_young);
};
